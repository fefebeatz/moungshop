  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4">
        <div className="bg-white p-4 sm:p-8 rounded-xl shadow lg w-full max-w-4xl">
           <h1 className="text-4xl font-bold text-gray-900 tracking-tight mb-8">Mes commandes</h1>
           {
            orders.length === 0 ?(
                    ...
                    <div 
                      ...
                      <div className="p-4 sm:p-6 border-b border-gray-200">
                        <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center mb-4">
                          ...
                          <div className="sm:text-right">
                            <p className="text-sm text-gray-600 mb-1">Date de la commande:</p>
                      ...
                      <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center p-4">
                        <div className="flex items-center">
                          ...
                          <span className={`px-3 py-1 rounded-full text-sm ${order.status === "paid" ? "bg-gold text-white" : "bg-gray-100 text-gray-800"}`}>{order.status}</span>
                        </div>
                        <div className="sm:text-right">
                            ...
                            <p className="text-sm text-gray-600">
                              ...
                              order.products?.map((product)=>(
                                <span key={product.product?._id}>
                                  {
                                    (product.quantity! * product.product?.price!) + order.amountDiscount!
                                  } FCFA
                                </span>
                              ))
                            }
                                  ...
                                  <p className="font-medium text-right">
                                      {
                                        ...
                                        `${product.product?.price * product.quantity} FCFA` : "N/A"
                                      }
                                    </p>
                                </div>
                              ))
