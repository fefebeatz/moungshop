...
export type Order = {
  ...
  _rev: string;
  orderNumber?: string;
  momoCheckoutSessionID?: string;
  momoCustomerID?: string;
  customerName?: string;
  customerEmail?: string;
  momoPaymentIntentID?: string;
  products?: Array<{
    product?: {
      _ref: string;
      _type: "reference";
...
// Query: *[            _type == "order" && clerkUserId == $userId        ] | order(orderDate desc) {            ...,            products[]{                ...,                product->{                    _id,                    name,                    price,                    image,                    slug,                    stock,                },            },        }
